...
const ChoroplethMap = ({ onCountyClick }) => {
  ...
  const colorScale = d3.scaleOrdinal()
    .domain(d3.range(5))
    .range(['#fffde7', '#fff176', '#ffd54f', '#ffb300', '#f57c00']);
  ...
  return (
    <div ref={containerRef} style={{ width: '100%', height: 'auto', aspectRatio: '2 / 1', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', maxWidth: '100%', minHeight: '240px', paddingBottom: '0px' }}>
      <svg ref={svgRef} width={width} height={height} viewBox={`0 0 ${width} ${height}`} preserveAspectRatio="xMidYMid meet" style={{ width: '100%', height: 'auto', display: 'block' }} >
      ...
      >
        {/* <ChoroplethLegend colorScale={colorScale} breaks={ratioBreaks} /> */}
